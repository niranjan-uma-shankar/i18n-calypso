...
I18N.prototype.translate = function() {
	var options, translation, sprintfArgs, errorMethod, optionsString, cacheable, isMissingTranslations;
	...
	if ( options.components ) {
		...
		if ( isMissingTranslations ) {
			component = Object.assign( { "bdo": { "type":"bdo","key":null,"ref":null,"props": { "dir":"ltr" },"_owner":null,"_store":{ } } }, component );
		}
		translation = "{{bdo}}" + translation + "{{/bdo}}";
		...
		if ( 'rtl' === direction ) {
			translation = "{{bdo}}" + translation + "{{/bdo}}";
			var component = {"bdo":{"type":"bdo","key":null,"ref":null,"props":{"dir":"ltr", "style":{"text-align":"left"}},"_owner":null,"_store":{}}};
			translation = interpolateComponents( {
				mixedString: translation,
				components: component,
			} );
